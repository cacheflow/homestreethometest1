...
Partners and the site admins also have access to a custom dashboard to track progress and see what's been the most effective in raising money. Data is pulled from the DB with custom sql queries and formatted as JSON. Charts were made with D3.

Tests writted in rspec, in the spec folder.

Current profiles are samples and not real homeless people. Index page has infinite scroll.
